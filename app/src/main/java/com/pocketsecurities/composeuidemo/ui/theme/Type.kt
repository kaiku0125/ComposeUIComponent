package com.pocketsecurities.composeuidemo.ui.theme
...
val Typography.text_10sp_400weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 10.sp,
...
val Typography.text_10sp_500weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 10.sp,
...
val Typography.text_11sp_500weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 11.sp,
            fontWeight = FontWeight(500),
...
val Typography.text_12sp_600weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 12.sp,
...
val Typography.text_13sp_600weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 13.sp,
            fontWeight = FontWeight(600),
...
val Typography.text_14sp_500weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 14.sp,
            fontWeight = FontWeight(500)
...
val Typography.text_16sp_400weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 16.sp,
            fontWeight = FontWeight(400)
...
val Typography.text_16sp_600weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 16.sp,
            fontWeight = FontWeight(600)
...
val Typography.text_21sp_600weight: TextStyle
    get() {
        return TextStyle(
            fontSize = 21.sp,
            fontWeight = FontWeight(600),
